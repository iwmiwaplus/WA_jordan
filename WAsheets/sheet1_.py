...
#        return None
    ...
    for i in range(len(df_P)):
        ...
        results['uf_plu'], results['uf_ulu'], results['uf_mlu'], results['uf_mwu'] = calc_utilizedflow(df_ETincr.iloc[i], results['other'], results['non_recoverable'], other_fractions, non_recoverable_fractions,unit_conversion)
...
def calc_utilizedflow(incremental_et, other, non_recoverable, other_fractions, non_recoverable_fractions, unit_conversion):
    """
    ...
    uf_mwu = incremental_et['MANAGED']/unit_conversion  + other_fractions['Managed'] * other + non_recoverable_fractions['Managed'] * non_recoverable
