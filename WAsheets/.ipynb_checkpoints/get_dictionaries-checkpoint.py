...
def get_lulcs(lulc_version = '4.0'):
    ...
    lulc['4.0'] = {
    "legend":["code","Water Management Classes","Water use - Land Use - Land Cover","Description","Beneficial T","Beneficial E","Beneficial I","Agriculture","Environment","Economic","Energy","Leisure"],
    1:["PLU1","Natural","Protected forests","All forest classes that are within a protected site (source of the protected sites www.protecttheplanet.org)",100,100,0,0,85,0,0,15],
    2:["PLU2","Natural","Protected shrubland","The savanna classes, shrubland and herbaceaous cover that are within a protected site.",100,100,0,0,85,0,0,15],
    3:["PLU3","Natural","Protected natural grasslands","The open grasslands and natural alpine pastures that are within a protected site",100,100,0,0,85,0,0,15],
    4:["PLU4","Natural","Protected natural waterbodies","Natural lakes and rivers that are within a protected site",100,100,0,0,85,0,0,15],
    5:["PLU5","Natural","Protected wetlands","Wetland & swamps, managroves that are within a protected site",100,100,0,0,85,0,0,15],
    6:["PLU6","Natural","Glaciers","All glaciers are considered protected sites",0,100,0,0,100,0,0,0],
    7:["PLU7","Natural","Protected other","All other ULU classes that are within a protected site (excluding Alien invasives species)",100,100,0,0,85,0,0,15],
    8:["ULU1","Natural","Closed deciduous forest","Leaf losing forest with a coverage percentage of more than 40%",100,0,0,5,90,0,0,5],
    9:["ULU2","Natural","Open deciduous forest","Leaf losing forest with a coverage percentage of less than 40%",100,0,0,5,90,0,0,5],
    10:["ULU3","Natural","Closed evergreen forest","Evergreen forest with a coverage percentage of more than 40%",100,0,0,5,90,0,0,5],
    11:["ULU4","Natural","Open evergreen forest","Evergreen forest with a coverage percentage of less than 40%",100,0,0,5,90,0,0,5],
    12:["ULU5","Natural","Closed savanna","Savanna type land with a coverage percentage of more than XX%",100,0,0,5,80,0,10,5],
    13:["ULU6","Natural","Open savanna","Savanna type land with a coverage percentage of less than XX%",100,0,0,10,80,0,5,5],
    14:["ULU7","Natural","Shrub land & mesquite","Shrubland type of land",100,0,0,5,85,0,10,0],
    15:["ULU8","Natural","Herbaceous cover","Low cover",100,0,0,5,95,0,0,0],
    16:["ULU9","Natural","Meadows & open grassland","Grasslands of different types",100,0,0,60,30,0,0,10],
    17:["ULU10","Natural","Riparian corridor","Vegetation along the banks of a river or stream",100,0,0,10,60,10,0,20],
    18:["ULU11","Natural","Deserts","Sand deserts areas",100,0,0,0,100,0,0,0],
    19:["ULU12","Natural","Wadis","Streams that are dry during part of the year",100,0,0,15,80,0,0,5],
    20:["ULU13","Natural","Natural alpine pastures","Mountain pastures",100,0,0,70,20,0,0,10],
    21:["ULU14","Natural","Rocks & gravel & stones & boulders","Rocks including stones, boulders, gravel and other stony surfaces.",100,0,0,0,95,0,0,5],
    22:["ULU15","Natural","Permafrosts","Permafrost",0,0,0,0,100,0,0,0],
    23:["ULU16","Natural","Brooks & rivers & waterfalls","Flowing water that is not a lake.",0,50,0,25,55,5,0,15],
    24:["ULU17","Natural","Natural lakes","Natural lakes",0,50,0,25,40,5,0,30],
    25:["ULU18","Natural","Flood plains & mudflats","Floodplains and mudflats that are temporaly flooded.",100,50,0,40,60,0,0,0],
    26:["ULU19","Natural","Saline sinks & playas & salinized soil","Salinized soil, including salt lake beds and salinized sinks",100,0,0,0,100,0,0,0],
    27:["ULU20","Natural","Bare soil","Bare soil that is permently bare, that does not consist of sand or rocks otherwise it would be ULU11 Deserts or ULU14 Rocks",0,0,0,0,100,0,0,0],
    28:["ULU21","Natural","Waste land","Land that has been abonded and has no specific type of vegeatation",0,0,0,0,100,0,0,0],
    29:["ULU22","Natural","Moorland","Moorlands",100,0,0,5,80,0,0,15],
    30:["ULU23","Natural","Wetland","Wetlands including swamsp (wet al year round)",100,50,0,5,80,0,5,10],
    31:["ULU24","Natural","Mangroves","Mangroves",100,50,0,5,80,0,5,10],
    32:["ULU25","Natural","Alien invasive species","Alien invasive species",0,0,0,0,60,0,10,30],
    33:["MLU1","Agricultural","Rainfed forest plantations","Forest plantations that are rainfed",100,0,0,90,0,10,0,0],
    34:["MLU2","Agricultural","Rainfed production pastures","Rainfed pastures for grazing",100,0,0,90,0,10,0,0],
    35:["MLU3","Agricultural","Rainfed crops - cereals","Rainfed Cereals as defined by the FAO classification of crops",100,0,0,90,0,10,0,0],
    36:["MLU4","Agricultural","Rainfed crops - root/tuber","Rainfed root/ tuber crops as defined by the FAO classification of crops",100,0,0,90,0,10,0,0],
    37:["MLU5","Agricultural","Rainfed crops - legumious","Rainfed legumious crops as defined by the FAO classification of crops",100,0,0,90,0,10,0,0],
    38:["MLU6","Agricultural","Rainfed crops - sugar","Rainfed sugar crops as defined by the FAO classification of crops",100,0,0,90,0,10,0,0],
    39:["MLU7","Agricultural","Rainfed crops - fruit and nuts","Rainfed fruits and nut as defined by the FAO classification of crops",100,0,0,90,0,10,0,0],
    40:["MLU8","Agricultural","Rainfed crops - vegetables and melons","Rainfed vegetables and melons as defined by the FAO classification of crops",100,0,0,90,0,10,0,0],
    41:["MLU9","Agricultural","Rainfed crops - oilseed","Rainfedl oilseed crops as defined by the FAO classificaiton of crops",100,0,0,45,0,15,40,0],
    42:["MLU10","Agricultural","Rainfed crops - beverage and spice","Rainfed beverage and spice crops as defined byt the FAO classification of crops",100,0,0,90,0,10,0,0],
    43:["MLU11","Agricultural","Rainfed crops - other","Rainfed other crops suchs as cotton or flax",100,0,0,80,0,20,0,0],
    44:["MLU12","Agricultural","Mixed species agro-forestry","Agriculture mixed with forest (swidden cultivation)",100,0,0,90,0,10,0,0],
    45:["MLU13","Natural","Fallow & idle land","Land that is not used and is thus idle or fallow",0,0,0,0,100,0,0,0],
    46:["MLU14","Natural","Dump sites & deposits","XX",0,0,0,0,0,60,40,0],
    47:["MLU15","Agricultural","Rainfed homesteads and gardens (urban cities) - outdoor","Rainfed houses and gardens in an urban environment",100,0,0,0,0,35,0,65],
    48:["MLU16","Agricultural","Rainfed homesteads and gardens (rural villages) - outdoor","Rainfed houses and gardens in a rural environment",100,0,0,0,0,35,0,65],
    49:["MLU17","Agricultural","Rainfed industry parks - outdoor","The greenery in a industial zone",100,0,0,0,0,50,0,50],
    50:["MLU18","Agricultural","Rainfed parks (leisure & sports)","Rainfed city parks that are for leisure and sports",100,0,0,0,15,0,0,85],
    51:["MLU19","Agricultural","Rural paved surfaces (lots, roads, lanes)","Rural paved surfaces such as road lots and other hard surfaces",100,0,0,0,0,100,0,0],
    52:["MWU1","Agricultural","Irrigated forest plantations","Forest plantations that are irrigated",100,0,0,90,0,10,0,0],
    53:["MWU2","Agricultural","Irrigated production pastures","Irrigated pastures for grazing",100,0,0,90,0,10,0,0],
    54:["MWU3","Agricultural","Irrigated crops - cereals","Irrigated Cereals as defined by the FAO classification of crops",100,0,0,90,0,10,0,0],
    55:["MWU4","Agricultural","Irrigated crops - root/tubers","Irrigated root/ tuber crops as defined by the FAO classification of crops",100,0,0,90,0,10,0,0],
    56:["MWU5","Agricultural","Irrigated crops - legumious","Irrigated legumious crops as defined by the FAO classification of crops",100,0,0,90,0,10,0,0],
    57:["MWU6","Agricultural","Irrigated crops - sugar","Irrigated sugar crops as defined by the FAO classification of crops",100,0,0,90,0,10,0,0],
    58:["MWU7","Agricultural","Irrigated crops - fruit and nuts","Irrigated fruits and nut as defined by the FAO classification of crops",100,0,0,90,0,10,0,0],
    59:["MWU8","Agricultural","Irrigated crops - vegetables and melons","Irrigated vegetables and melons as defined by the FAO classification of crops",100,0,0,90,0,10,0,0],
    60:["MWU9","Agricultural","Irrigated crops - Oilseed","Irrigatedl oilseed crops as defined by the FAO classificaiton of crops",100,0,0,65,0,10,25,0],
    61:["MWU10","Agricultural","Irrigated crops - beverage and spice","Irrigated beverage and spice crops as defined byt the FAO classification of crops",100,0,0,90,0,10,0,0],
    62:["MWU11","Agricultural","Irrigated crops - other","Irrigated other crops suchs as cotton or flax",100,0,0,80,0,20,0,0],
    63:["MWU12","Agricultural","Managed water bodies (reservoirs, canals, harbors, tanks)","Waterbodies that are managed such as canals reservoirs and ponds",0,100,0,35,5,30,20,10],
    64:["MWU13","Agricultural","Greenhouses - indoor","Greenhouses",100,0,0,100,0,0,0,0],
    65:["MWU14","Agricultural","Aquaculture","Aquaculture",0,100,0,90,0,10,0,0],
    66:["MWU15","Urban","Domestic households - indoor (sanitation)","The indoor water consumption of a household, the santitation water",0,100,0,0,0,35,0,65],
    67:["MWU16","Urban","Manufacturing & commercial industry - indoor","The indoor water consumption related to manufacturing and industry",0,100,0,0,0,100,0,0],
    68:["MWU17","Urban","Irrigated homesteads and gardens (urban cities) - outdoor","Irrigated houses and gardens in an urban environment",100,0,0,30,5,15,0,50],
    69:["MWU18","Urban","Irrigated homesteads and gardens (rural villages) - outdoor","Irrigated houses and gardens in a rural environment",100,0,0,30,5,15,0,50],
    70:["MWU19","Urban","Irrigated industry parks - outdoor","The greenery in an industrial zone",100,0,0,0,15,35,0,50],
    71:["MWU20","Urban","Irrigated parks (leisure, sports)","Irrigated city parks that are for leisure and sports",100,0,0,0,0,0,0,100],
    72:["MWU21","Urban","Urban paved Surface (lots, roads, lanes)","",100,0,0,0,0,100,0,0],
    73:["MWU22","Urban","Livestock and domestic husbandry","Water consumption by livestock and domestic husbandry",100,0,0,90,0,10,0,0],
    74:["MWU23","Urban","Managed wetlands & swamps","Wetlands that are managed (wet the whole year)",100,50,0,0,65,10,0,25],
    75:["MWU24","Urban","Managed other inundation areas","Managed areas that are flooded part of the year",100,50,0,0,55,20,0,25],
    76:["MWU25","Urban","Mining/ quarry & shale exploration","Mining areas",100,50,0,0,0,100,0,0],
    77:["MWU26","Urban","Evaporation ponds","Evaporation ponds",0,100,0,0,75,25,0,0],
    78:["MWU27","Urban","Waste water treatment plants","Waste water treatment plants",0,100,0,0,55,45,0,0],
    79:["MWU28","Urban","Hydropower plants","Hydropower plants",0,100,0,0,0,0,97.5,2.5],
    80:["MWU29","Urban","Thermal power plants","Thermal power plants either gas, nuclear, or coal fired.",0,100,0,0,0,0,100,0]
...
def get_sheet1_classes(lulc_version = '4.0'):
    ...
    categories = ['Natural', 'Agricultural', 'Urban']
    sheet1_classes = dict()
    for cat in categories:
        sheet1_classes[cat] = [key for key, value in zip(list(lulc_dict.keys()), list(lulc_dict.values())) if value[1] == cat]
    sheet1_classes['NATURAL']=sheet1_classes.pop('Natural')
    sheet1_classes['AGRICULTURAL']=sheet1_classes.pop('Agricultural')
    sheet1_classes['URBAN']=sheet1_classes.pop('Urban')
