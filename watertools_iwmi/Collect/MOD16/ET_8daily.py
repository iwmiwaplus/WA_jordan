import sys
from watertools_iwmi.Collect.MOD16.DataAccess import DownloadData
...
def main(Dir, Startdate, Enddate, latlim, lonlim, cores=False, Waitbar = 1, hdf_library = None, remove_hdf = 1):
    ...
    timestep = '8-daily'
    output = DownloadData(Dir, Startdate, Enddate, latlim, lonlim, timestep, Waitbar, cores, hdf_library, remove_hdf)
