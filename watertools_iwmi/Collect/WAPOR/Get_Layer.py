...
"""
import sys
from watertools_iwmi.Collect.WAPOR.DataAccess import WAPOR

def main(output_folder, Startdate, Enddate, latlim, lonlim, Parameter, cores = False, Area = None, Version = "2"):
    ...
    WAPOR(output_folder, Startdate, Enddate, latlim, lonlim, Parameter, cores, Area = None, Version = "2")
